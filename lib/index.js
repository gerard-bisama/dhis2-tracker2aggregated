...
function getTrackedEntities(currentPage,program,parentOrgUnit,pageSize,globalEntitiesList,callback)
{
	...
	if(currentPage==0)
	{
		...
		urlRequest=`${baseUrlAPI}/trackedEntityInstances.json?ou=${parentOrgUnit}&ouMode=DESCENDANTS&program=${program}&programStartDate=${programStartDate}&pageSize=${pageSize}&totalPages=true&page=1&fields=trackedEntityInstance,orgUnit,attributes`;
		...
		urlRequest=`${baseUrlAPI}/trackedEntityInstances.json?ou=${parentOrgUnit}&ouMode=DESCENDANTS&program=${program}&programStartDate=${programStartDate}&pageSize=${pageSize}&totalPages=true&page=${currentPage}&fields=trackedEntityInstance,orgUnit,attributes`;
		//console.log("------------------------------");
		console.log(urlRequest);
	}
