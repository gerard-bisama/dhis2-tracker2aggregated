...
=======
>>>>>>> cd02213fd93af54ff4fe433c3adfaf09f92ddd9f
...
=======
			if(hasCdvClientARecuResultatTestVIH_Yes && hasCdvResultatVIH_PositifOrNegatif )
>>>>>>> cd02213fd93af54ff4fe433c3adfaf09f92ddd9f
			{
				//console.log("Selected :"+oEvent.event);
				listValidEvents.push(oEvent);
...
function getTrackedEntities(currentPage,program,parentOrgUnit,pageSize,globalEntitiesList,callback)
{
	...
	{
		//console.log("First Iteration");
		urlRequest=`${baseUrlAPI}/trackedEntityInstances.json?ou=${parentOrgUnit}&ouMode=DESCENDANTS&programStartDate=${programStartDate}&program=${program}&pageSize=${pageSize}&totalPages=true&page=1&fields=trackedEntityInstance,orgUnit,attributes`;
	
	}
	else{
		//console.log("Other iteration");
		urlRequest=`${baseUrlAPI}/trackedEntityInstances.json?ou=${parentOrgUnit}&ouMode=DESCENDANTS&programStartDate=${programStartDate}&program=${program}&pageSize=${pageSize}&totalPages=true&page=${currentPage}&fields=trackedEntityInstance,orgUnit,attributes`;
		//console.log("------------------------------");
		console.log(urlRequest);
	}
...
=======
				for(var i=0;i<oEvent.dataValues.length;i++)
				{
					...
					{
						oEvent.dataValues[i].value=entityAttribute[indexAttribute].value;
						_event=oEvent;
